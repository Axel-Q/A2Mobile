...
export const myStyle = {
  homePageContainer: {
    flex: 1,
    backgroundColor: reusableColor.background,
    alignItems: 'center',
  ...
  title: {
    fontSize: 16,
    color: reusableColor.textPrimary,
    fontWeight: "bold",
    flex: 1,
  },
  BottomTabNavigator: {
    tabBarActiveTintColor: reusableColor.accent,
    tabBarInactiveTintColor: reusableColor.inactiveTint,
    headerStyle: {
  ...
  EachItemText: {
    fontSize: 15,
    color: reusableColor.textSecondary,
    marginRight: 10,
  },
  EachItemDuration: {
    fontSize: 15,
    backgroundColor: reusableColor.white,
